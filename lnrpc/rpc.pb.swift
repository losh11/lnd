...
struct Lnrpc_Utxo {
  ...
  var scriptPubkey: String {
    get {return _storage._scriptPubkey}
    set {_uniqueStorage()._scriptPubkey = newValue}
  }

  //// The outpoint in format txid:n
  //// Note that this reuses the `ChannelPoint` message but
  //// is not actually a channel related outpoint, of course
  var outpoint: Lnrpc_ChannelPoint {
    get {return _storage._outpoint ?? Lnrpc_ChannelPoint()}
...
extension Lnrpc_Utxo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _scriptPubkey: String = String()
    var _outpoint: Lnrpc_ChannelPoint? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _scriptPubkey = source._scriptPubkey
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularStringField(value: &_storage._scriptPubkey)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._scriptPubkey.isEmpty {
        try visitor.visitSingularStringField(value: _storage._scriptPubkey, fieldNumber: 4)
      }
  ...
  static func ==(lhs: Lnrpc_Utxo, rhs: Lnrpc_Utxo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._scriptPubkey != rhs_storage._scriptPubkey {return false}
